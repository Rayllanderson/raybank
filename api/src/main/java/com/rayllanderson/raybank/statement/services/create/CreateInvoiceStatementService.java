...
public class CreateInvoiceStatementService implements CreateStatementService {
    ...
    public void process(final Transaction transaction) {
        final String invoiceId = ((InvoicePaymentTransaction) transaction).getInvoiceId();
    ...
    public boolean supports(final Transaction transaction) {
        return transaction instanceof InvoicePaymentTransaction;
    }
}
